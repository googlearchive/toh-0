define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_tour_of_heroes/app_component.template', 'packages/angular/src/platform/bootstrap', 'packages/angular_tour_of_heroes/app_component'], function(dart_sdk, angular, app_component, bootstrap, app_component$) {
  'use strict';
